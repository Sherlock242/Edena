      ...
      <main className="flex-1 flex flex-col items-center justify-center p-4 md:p-8 overflow-auto">
        <div className="w-full max-w-2xl flex flex-col items-center justify-center text-center">
            ...
            >
                <AnimatePresence>
                    {recordingState === 'recording' && (
                        ...
                        >
                            <Waves className="w-full h-full text-red-500/50 animate-pulse-slow" />
                        </motion.div>
                    )}
                </AnimatePresence>
                ...
                <motion.div 
                    ...
                    animate={{ scale: orbState ? 1.1 : 1 }} 
                    transition={{ type: 'spring', stiffness: 300, damping: 15 }}
                >
                    {recordingState === 'idle' && <Mic className="w-12 h-12 text-white/80" />}
            ...
            <AnimatePresence mode="wait">
                ...
                >
                    {recordingState === 'idle' && <p className="text-lg text-muted-foreground">Click the orb and speak to provide a voice sample.</p>}
            ...
            <div className="w-full grid gap-6 mt-8">
                <Card className="bg-card/50 border-purple-500/30">
                    <CardHeader>
                    <CardTitle>1. Enter Text to Synthesize</CardTitle>
                ...
                <AnimatePresence>
                    {generatedAudio && recordingState === 'finished' && (
                        ...
                        >
                            <Card className="bg-card/50 border-purple-500/30">
                            <CardHeader>
                                <CardTitle className="flex items-center"><Play className="mr-2 text-purple-400" />2. Result</CardTitle>
