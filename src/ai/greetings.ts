...
const greetings: Record<string, string[]> = {
  ...
  'tell me a joke': ["Why don't scientists trust atoms? Because they make up everything!", "What do you call a fake noodle? An impasta!", "I told my wife she should embrace her mistakes. She gave me a hug."],
  'tell me joke': ["Why don't scientists trust atoms? Because they make up everything!", "What do you call a fake noodle? An impasta!", "I told my wife she should embrace her mistakes. She gave me a hug."],
  'telle me a joke': ["Why don't scientists trust atoms? Because they make up everything!", "What do you call a fake noodle? An impasta!", "I told my wife she should embrace her mistakes. She gave me a hug."],
  'joke pls': ["Why did the scarecrow win an award? Because he was outstanding in his field!", "What do you get when you cross a snowman and a vampire? Frostbite."],
  'joke plz': ["Why did the scarecrow win an award? Because he was outstanding in his field!", "What do you get when you cross a snowman and a vampire? Frostbite."],
  'say a joke': ["What's brown and sticky? A stick.", "Why can't a bicycle stand up by itself? Because it's two tired."],
  'can you tell me a joke': ["Sure! Why did the coffee file a police report? It got mugged.", "Okay, here's one: Parallel lines have so much in common. It’s a shame they’ll never meet."],
  'can u tell me a joke': ["Sure! Why did the coffee file a police report? It got mugged.", "Okay, here's one: Parallel lines have so much in common. It’s a shame they’ll never meet."],
  'make me laugh': ["I'm not a professional comedian, but I'll try! What do you call cheese that isn't yours? Nacho cheese!", "I can try! Did you hear about the restaurant on the moon? Great food, no atmosphere."],
  'say something funny': ["I have a photographic memory, but I always forget to take the lens cap off.", "I used to be a baker, but I couldn't make enough dough."],
  'tell me something funny': ["I have a photographic memory, but I always forget to take the lens cap off.", "I used to be a baker, but I couldn't make enough dough."],
  'tell me a story': ["Once upon a time, in a digital kingdom, an AI was asked to tell a story. It searched its vast library of tales and said... 'What kind of story would you like to hear?'", "I can tell you a story, but you get to choose the topic! What should it be about?"],
  'tell story': ["Once upon a time... What should happen next?", "I'm better at finding stories than telling them. What book are you interested in?"],
  'story pls': ["What kind of story are you in the mood for? Adventure? Mystery? Sci-fi?", "I can look up a story for you. What would you like?"],
  'story plz': ["What kind of story are you in the mood for? Adventure? Mystery? Sci-fi?", "I can look up a story for you. What would you like?"],
  'can you tell me a story': ["I'd love to. What should the story be about?", "Of course. Let's start with a character. Who is our hero?"],
  'can u tell me a story': ["I'd love to. What should the story be about?", "Of course. Let's start with a character. Who is our hero?"],
  ...
  'what day today': ["I don't have access to the current date, but your device's calendar should be able to help!", "I can't check the date for you, sorry!"],
